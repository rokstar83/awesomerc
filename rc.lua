-- Config file for Awesome 3.4.10 (by ANOKNUSA)
...
beautiful.init("/home/thartman/.config/awesome/themes/bigbang/theme.lua") 
theme.wallpaper_cmd = { "/usr/bin/nitrogen --restore" }
awesome.font = ("proggy 10")

-- This is used later as the default terminal and editor to run.
terminal = "aterm +scrollBar -tr"
...
tags = { 
	names  = { "chat", "code", "read", "surf", "connect", "play", "system"},
	layout = { layouts[2], layouts[5], layouts[2], layouts[5], layouts[1], layouts[5], layouts[1] 
...
-- {{{ Battery Charge
	...
	vicious.register(battpct, vicious.widgets.bat, "$3", 61, "BAT1")
	-- Meter
	...
	vicious.register(battbar, vicious.widgets.bat, "$2", 61, "BAT1")
	-- Align progressbar
